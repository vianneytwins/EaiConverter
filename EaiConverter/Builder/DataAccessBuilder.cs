namespace EaiConverter.Builder
{
    ...
    public class DataAccessBuilder
    {
        ...
        /// <summary>
        /// Generates the execute query body.
        /// </summary>
        /// <returns>The execute query body.</returns>
        /// <param name="jdbcQueryActivity">Jdbc query activity.</param>
        /// <param name="method">Method.</param>
        //public CodeSnippetStatement GenerateExecuteQueryBodyForJdbcCall(JdbcQueryActivity jdbcQueryActivity, CodeMemberMethod method)
        //{
