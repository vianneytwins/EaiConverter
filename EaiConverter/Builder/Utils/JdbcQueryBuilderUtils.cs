namespace EaiConverter.Builder
{
    ...
    public static class JdbcQueryBuilderUtils
    {
        private static Dictionary<string, string> sqlMapping = new Dictionary<string, string> {
            ...
            { "FLOAT", CSharpTypeConstant.SystemDouble },
            { "DATE", CSharpTypeConstant.SystemDateTime },
            { "DATETIME", CSharpTypeConstant.SystemDateTime },
            { "SMALLDATETIME", CSharpTypeConstant.SystemDateTime },
            { "TIMESTAMP", CSharpTypeConstant.SystemDateTime },
            { "BIT", CSharpTypeConstant.SystemBoolean },
            { "VARBINARY", CSharpTypeConstant.SystemInt32 },
            { "REAL",  CSharpTypeConstant.SystemDouble },
